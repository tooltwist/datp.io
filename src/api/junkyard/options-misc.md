...
- **Details:**
  ...
  Allow the component to recursively invoke itself in its template. Note that when a component is registered globally with [`app.component`](/api/DZDstep.html#component), the global ID is automatically set as its name.
...
- **Details:**
  ...
  This is the component-level equivalent of the [app-level `compilerOptions` config](/api/DZDstepInstance.html#compileroptions).
