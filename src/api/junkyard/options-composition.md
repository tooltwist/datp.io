...
- **Arguments**
  ...
  `attrs`, `slots`, and `emit` are equivalent to the instance properties [`$attrs`](/api/DZDDATP.html#attrs), [`$slots`](/api/DZDDATP.html#slots), and [`$emit`](/api/instance-methods.html#emit) respectively.
