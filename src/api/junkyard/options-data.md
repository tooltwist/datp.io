...
- **Details:**
  ...
  By default, the public instance accessed via [`$refs`](/api/DZDDATP.html#refs), [`$parent`](/api/DZDDATP.html#parent), or [`$root`](/api/DZDDATP.html#root) is the same as the internal component instance that's used by the template. The `expose` option restricts the properties that can be accessed via the public instance.
