...
If you're using a [CDN](/guide/DZDinstallation.html#cdn) build of Vue then `createApp` is exposed via the global `Vue` object:
...
The equivalent in Vue 3 is [`config.globalProperties`](/api/DZDstepInstance.html#globalproperties). These properties will be copied across as part of instantiating a component within the application:
